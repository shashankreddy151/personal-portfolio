...
1. Run the project before making any modifications by following the set up and running instructions in the main [README.md](https://github.com/shashankreddy151/personal-portfolio-#set-up).
...
See deployment instructions [here](https://github.com/shashankreddy151/personal-portfolio-#deploying-to-github-pages). If you plan to use a custom url, modify `public/CNAME` and enter your URL. You can run:
...
2. LF / CRLF issues with eslint.
   ...
   This is a common Windows development pitfall. See @[FrozenFury](https://github.com/FrozenFury)'s [comment](https://github.com/shashankreddy151/personal-portfolio/issues/263#issuecomment-759216299) for how to update your eslint config to resolve this issue.
